...
public class ChatExtension {
    ...
    public static final int COOPERATIONTASK = 8;
    ...
    public Object chat(int playerId, ChatVo vo) {
        ...
        //封禁检测
        if (managerService.checkBan(String.valueOf(playerId), ManagerService.BAN_CHAT)) {
            chatInfoList.errorCode = Response.BAN_LOGIN;
            return chatInfoList;
        }
...
//		}
        ...
        int chatType = 0;
        //世界
        if (vo.channel == WORLD || vo.channel == SYS || vo.channel == INVIT || vo.channel == COOPERATIONTASK) {
