...
public class BagExtension {
    ...
    // 穿上
    @Command(1203)
    public Object wear(int playerId, LongList param) {
        int result = equipService.wear(playerId, param.lList);
    ...
    //升阶
    @Command(1208)
    public Object upStar(int playerId, Long2Param param) {
        IntParam result = new IntParam();
        result.param = equipService.upStar(playerId, param);
        return result;
    }

    //强化
    @Command(1209)
    public Object strength(int playerId, Int3Param int3Param) {
        IntParam result = new IntParam();
        int type = int3Param.param1;
        int code = equipService.strength(playerId, type, int3Param.param2 == 1,int3Param.param3);
        result.param = code;
        return result;
    }
